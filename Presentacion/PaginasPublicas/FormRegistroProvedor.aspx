<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormRegistroProvedor.aspx.cs" Inherits="Presentacion.PaginasPublicas.FormRegistroProvedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 style="text-align:center;">Registro de Proveedor</h2>
                ...
                <div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group" style="text-align:center; margin-top:20px;">
                            ...
                            <asp:Button ID="btnCancelar" runat="server" CssClass="boton-personalizado" Text="Cancelar" />
                        </div>
                    </div>
